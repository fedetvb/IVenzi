...
export type SavePathType = 'backup' | 'fiches' | 'fiches_nero' | 'fiches_tutte' | 'fiches_dichiarate' | 'fiches_non_dichiarate' | 'fiches_xls_tutte' | 'fiches_xls_dichiarate' | 'fiches_xls_non_dichiarate' | 'clienti' | 'finanze' | 'finanze_xls' | 'finanze_csv' | 'magazzino' | 'rivendita' | 'statistiche' | 'qrcode' | 'comunicazioni';
