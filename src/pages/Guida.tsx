...
const GUIDE_ITEMS: GuideItem[] = [
  ...
  },
  {
    ...
    description: 'La ricarica aggiunge credito alla carta premium della cliente. Il sistema calcola automaticamente quanto paga la cliente in base al credito acquistato.',
    steps: [
      'Vai su Carte → tab "Premium".',
      'Trova la carta da ricaricare e clicca "Ricarica".',
      'Scegli l\'importo di credito da aggiungere (ci sono importi preset o liberi).',
      'Il sistema mostra quanto paga la cliente (formula: credito × 250/300).',
  ...
  },
  {
    ...
    description: 'Genera un QR code che le clienti possono scansionare per compilare autonomamente la scheda di registrazione (nome, telefono, allergie, ecc.).',
    steps: [
