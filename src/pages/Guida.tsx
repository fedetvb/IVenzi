...
const GUIDE_ITEMS: GuideItem[] = [
  ...
  // ── CARTE ──
  {
    ...
    sectionColor: 'teal',
    title: 'Panoramica del sistema carte',
    description: 'Il gestionale supporta tre tipi di carte: Carta Sconto (riduzione sul prezzo), Carta Premium (credito prepagato con bonus) e Gift Pass (buono regalo). Ognuna ha logiche diverse di creazione, utilizzo e comunicazione con la cliente.',
    tips: [
      'Carta Sconto → applica un risparmio su una fiche (%, importo fisso o listino prezzi dedicato).',
      'Carta Premium → la cliente versa credito e ottiene di più (es. paga 250€ e riceve 300€ da spendere).',
  ...
  },
  {
    ...
    sectionIcon: CreditCard,
    sectionColor: 'teal',
    title: 'Carta Sconto — funzione e utilizzo',
    description: 'La Carta Sconto applica una riduzione al totale di una fiche. Esistono tre varianti: Percentuale (es. 20% di sconto), Fisso (es. 10€ di sconto) e Listino (prezzi personalizzati per categoria di servizi). La cliente non la "usa" da sola: sei tu che la applichi al momento del pagamento.',
    steps: [
      'Vai su Carte → tab "Sconto" e clicca "Nuova Carta Sconto".',
      'Scegli il tipo: Percentuale, Fisso in € oppure Listino (prezzi su misura per categoria).',
      'Inserisci il valore (es. 20 per 20%, oppure 10 per 10€).',
      'Decidi se è usa e getta: se attivato, la carta si disattiva dopo il primo utilizzo.',
      'Decidi se è nominativa: puoi assegnarla a una cliente specifica oppure lasciarla generica (usabile da chiunque abbia il codice).',
      'Il codice viene generato automaticamente nel formato SCONTO-XXXX-XXXX.',
      'Salva. Opzionale: clicca "Invia WhatsApp" per comunicare il codice alla cliente.',
      'Al momento del pagamento, cerca la carta per codice e applicala alla fiche — lo sconto si calcola automaticamente e si registra lo storico utilizzo.',
    ],
    tips: [
      'Usa e getta è ideale per promozioni una tantum (compleanni, benvenuto, Natale).',
      'Il tipo Listino è utile se hai clienti convenzionate con prezzi fissi per ogni servizio.',
      'Il campo "Donazione" traccia quando una cliente regala la carta a un\'altra.',
    ],
    warnings: [
      'Se la carta è usa e getta, una volta applicata si disattiva automaticamente — non è possibile riutilizzarla.',
    ],
    tags: ['carte', 'sconto', 'percentuale', 'fisso', 'listino', 'usa e getta', 'nominativa', 'codice sconto', 'coupon'],
  },
  {
    id: 'carte-premium-funzione',
    section: 'Carte',
    sectionIcon: CreditCard,
    sectionColor: 'teal',
    title: 'Carta Premium — funzione e utilizzo',
    description: 'La Carta Premium è una carta prepagata nominativa: la cliente versa un importo e riceve un credito superiore (es. paga 250€ e ottiene 300€ da spendere). Il credito si detrae automaticamente ad ogni utilizzo. È sempre associata a una cliente specifica — non è trasferibile.',
    steps: [
      'Vai su Carte → tab "Premium" e clicca "Nuova Carta Premium".',
      'Seleziona la cliente intestataria (obbligatoria).',
      'Scegli l\'importo di credito: 100, 150, 200, 300, 400, 500€ oppure un valore personalizzato.',
      'Il sistema calcola automaticamente quanto paga la cliente (es. 300€ di credito = 250€ pagati). Il prezzo è già scontato.',
      'Conferma: viene creata la carta e una fiche automatica convalidata per l\'importo pagato.',
      'Invia WhatsApp per comunicare il codice e il saldo alla cliente.',
      'Quando la cliente paga con la carta, clicca "Usa" → inserisci l\'importo → il saldo si aggiorna.',
    ],
    tips: [
      'Puoi ricaricare la carta in qualsiasi momento: standard (cliente paga, si crea una nuova fiche) o gratuita (bonus omaggio, nessuna fiche).',
      'Ogni movimento — ricarica o utilizzo — viene registrato nello storico della carta.',
      'Se il saldo è insufficiente per coprire il totale, puoi detrarre il disponibile e incassare il resto separatamente.',
    ],
    warnings: [
      'La carta premium è strettamente nominativa: non può essere ceduta o usata da un\'altra cliente.',
    ],
    tags: ['carte', 'premium', 'prepagata', 'credito', 'saldo', 'ricarica', 'bonus', 'nominativa'],
  },
  {
    id: 'carte-premium-ricarica',
    section: 'Carte',
    sectionIcon: CreditCard,
    sectionColor: 'teal',
    title: 'Carta Premium — ricaricare il credito',
    description: 'Puoi aggiungere credito a una carta premium esistente in due modalità: Standard (la cliente paga e si genera una fiche automatica) o Gratuita (aggiungi credito come omaggio senza creare una fiche).',
    steps: [
      'Vai su Carte → tab "Premium", trova la carta della cliente.',
      'Clicca "Ricarica".',
      'Scegli l\'importo di credito da aggiungere (preset 100–500€ o importo libero).',
      'Seleziona il tipo: Standard (la cliente paga) oppure Gratuito (bonus omaggio).',
      'Se Standard: viene creata e convalidata automaticamente una fiche per l\'importo pagato.',
      'Se Gratuito: solo il saldo si aggiorna, nessuna fiche creata.',
      'Invia WhatsApp per comunicare il nuovo saldo alla cliente.',
    ],
    tips: ['La ricarica gratuita è utile per fidelizzare le clienti o compensare disservizi.'],
    tags: ['carte', 'premium', 'ricarica', 'credito', 'bonus', 'gratuito', 'standard'],
  },
  {
    id: 'carte-gift-pass',
    section: 'Carte',
    sectionIcon: CreditCard,
    sectionColor: 'teal',
    title: 'Gift Pass — buono regalo (funzione e creazione)',
    description: 'Il Gift Pass è un buono regalo che puoi creare per conto di una cliente che vuole farne dono a qualcun altro — oppure per uso personale. Può contenere un valore in euro (credito spendibile in salone) oppure un prodotto specifico del catalogo rivendita.',
    steps: [
      'Vai su Carte → tab "Gift Pass" oppure crea il pass direttamente dalla pagina Fiches al momento della chiusura.',
      'Scegli il tipo: Valore in € (importi rapidi 20–100€ o libero) oppure Prodotto (scegli dal catalogo).',
      'Seleziona l\'occasione: Invito, Compleanno o Regalo.',
      'Inserisci i dati del compratore (cliente esistente o nuova cliente da creare al volo) — viene generata una fiche automatica intestata a lei.',
      'Inserisci i dati della destinataria (chi riceverà il gift pass): nome e telefono. Puoi lasciarlo vuoto se non ancora noto.',
      'Se è nominativa (la cliente lo usa per sé), attiva il flag "Per uso personale".',
      'Salva. Il codice a 5 cifre viene generato automaticamente.',
      'Clicca "Invia WhatsApp" per mandare il codice alla destinataria — il flag "Donata" si attiva.',
    ],
    tips: [
      'Per i gift pass di tipo Prodotto puoi impostare una scadenza di ritiro (default 30 giorni) e una scadenza d\'uso (default 60 giorni dall\'attivazione).',
      'I gift pass di tipo Valore non hanno scadenza.',
      'Puoi creare il pass anche durante la chiusura di una fiche, collegandolo direttamente al pagamento.',
    ],
    tags: ['carte', 'gift pass', 'buono regalo', 'regalo', 'valore', 'prodotto', 'scadenza', 'codice'],
  },
  {
    id: 'carte-gift-pass-donazione',
    section: 'Carte',
    sectionIcon: CreditCard,
    sectionColor: 'teal',
    title: 'Gift Pass — dinamica di donazione e ricezione',
    description: 'Il Gift Pass nasce per essere regalato. Il flusso prevede un compratore (chi paga), una destinataria (chi riceve il regalo) e il momento in cui la destinataria viene in salone a riscattarlo.',
    steps: [
      'FASE 1 — ACQUISTO: La cliente A viene in salone e paga per un Gift Pass destinato alla cliente B. Tu crei il pass, inserisci i dati di B (nome + telefono) e generi la fiche a nome di A.',
      'FASE 2 — INVIO: Clicca "Invia WhatsApp" — B riceve un messaggio con il codice a 5 cifre. Il flag "Donata" si attiva, indicando che il codice è stato comunicato.',
      'FASE 3 — RISCATTO: B viene in salone, ti dà il codice. Vai su Gift Pass, cerca il codice e verifica che sia attivo e non scaduto.',
      'FASE 4 — UTILIZZO: Se è un valore in €, applicalo come credito sulla fiche di B. Se è un prodotto, eroga il prodotto e segna il pass come "Utilizzato".',
    ],
    tips: [
      'Se B non è ancora una cliente registrata al momento dell\'acquisto, puoi creare la scheda al volo durante la creazione del pass.',
      'Il flag "Donata" ti dice se il codice è già stato inviato alla destinataria.',
      'Se il pass scade prima che B lo utilizzi, puoi vedere la data di scadenza nel dettaglio del pass.',
    ],
    warnings: [
      'Un Gift Pass segnato come "Utilizzato" non può essere riapplicato — assicurati di segnarlo solo quando il servizio/prodotto è stato effettivamente erogato.',
    ],
    tags: ['carte', 'gift pass', 'donazione', 'regalo', 'compratore', 'destinataria', 'riscatto', 'codice', 'whatsapp'],
  },
  {
    id: 'carte-sms',
    section: 'Carte',
    sectionIcon: CreditCard,
    sectionColor: 'teal',
    title: 'Inviare messaggi WhatsApp per le carte',
    description: 'Per ogni tipo di carta puoi inviare un messaggio WhatsApp alla cliente: alla creazione (per comunicare il codice), alla ricarica (per aggiornare il saldo), all\'utilizzo (per confermare la detrazione) e al momento del regalo (per consegnare il codice alla destinataria).',
    steps: [
      'Trova la carta nella lista e clicca l\'icona "WhatsApp" o "SMS".',
      'Si apre il modal con un messaggio precompilato che include nome, codice e importo/saldo.',
      'Il testo è modificabile prima dell\'invio.',
      'Clicca "Apri WhatsApp" — si apre la chat con la cliente e il messaggio pronto da inviare.',
    ],
    tips: [
      'I template dei messaggi per le Carte Sconto si configurano in Impostazioni → Template Messaggi Carta Sconto.',
      'Puoi usare le variabili {nome}, {codice}, {sconto}, {da} per personalizzare automaticamente il testo.',
    ],
    tags: ['carte', 'sms', 'whatsapp', 'messaggio', 'notifica', 'template', 'codice'],
  },
